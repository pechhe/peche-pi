...
const desktopIpc = {
  ...
  createBranch: "pi-gui:create-branch",
  getWorkspaceDiffStat: "pi-gui:workspace-diff-stat",
  generatePrDraft: "pi-gui:generate-pr-draft",
  prCreate: "pi-gui:pr-create",
  checkPrMergeStatus: "pi-gui:check-pr-merge-status",
  mergePr: "pi-gui:merge-pr",
  openPrInBrowser: "pi-gui:open-pr-in-browser",
...
export const desktopIpcContracts: readonly IpcContractEntry[] = [
  ...
  { methodName: "getWorktreeRemovalPreview", channel: desktopIpc.getWorktreeRemovalPreview, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  ...
  { methodName: "setAutoShip", channel: desktopIpc.setAutoShip, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  { methodName: "setCommitPushMode", channel: desktopIpc.setCommitPushMode, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  ...
  { methodName: "checkPrMergeStatus", channel: desktopIpc.checkPrMergeStatus, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  { methodName: "mergePr", channel: desktopIpc.mergePr, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  { methodName: "openPrInBrowser", channel: desktopIpc.openPrInBrowser, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  { methodName: "listBranches", channel: desktopIpc.listBranches, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  { methodName: "checkoutBranch", channel: desktopIpc.checkoutBranch, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  { methodName: "createBranch", channel: desktopIpc.createBranch, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
  { methodName: "getWorkspaceDiffStat", channel: desktopIpc.getWorkspaceDiffStat, direction: "renderer-to-main", kind: "invoke", adapter: "git" },
