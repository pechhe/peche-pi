...
export class PersistenceManager {
  ...
  async persistUiState(): Promise<void> {
    ...
    const payload: PersistedUiState = {
      ...
      modelSelectorPinnedKeys: state.modelSelectorPinnedKeys?.length ? state.modelSelectorPinnedKeys : undefined,
      modelSelectorHiddenKeys: state.modelSelectorHiddenKeys?.length ? state.modelSelectorHiddenKeys : undefined,
